...
class TrelloFacadeTest {
    ...
    void testCreateCard(){
        ...
        TrelloCard trelloCard = new TrelloCard("name", "description", "pos", "list");
        ...
        //then
        assertEquals(createdTrelloCardDto.getId(), newCreatedTrelloCardDto.getId());
        assertEquals(createdTrelloCardDto.getName(), newCreatedTrelloCardDto.getName());
        assertEquals(createdTrelloCardDto.getShortUrl(), newCreatedTrelloCardDto.getShortUrl());
    }
